...
p_2 = st.sidebar.number_input('$p_2$', value=3, min_value=1, step=1)
...
cross_coupling_b = st.sidebar.number_input(r'$\kappa_b$', value=0.4, min_value=0., max_value=1., step=0.01)
