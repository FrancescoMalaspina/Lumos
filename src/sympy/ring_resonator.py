...
class SymPy_RingResonator:
    ...
    def pole_zero_plot(self, pin, l, cross_coupling_1, unitary_loss_coefficient, fig=None, ax=None):
    ...
    def magnitude_response_plot(self, pin, l, cross_coupling_1, unitary_loss_coefficient, fig=None, ax=None):
        if fig is None or ax is None:
